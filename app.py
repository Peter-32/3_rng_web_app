...
services = ['search bar indexed sites',
'explore categorized sites',
'shop (affiliate)',
'review',
'content',
'anonymous forum',
...
'music streaming',
'image streaming',
'short video clips streaming',
'video streaming',
'movie/series streaming',
'video game streaming',
'microblogging',
'personalized homepage creation',
'group video calls',
'group voice calls',
'knowledge',
'wisdom',
...
'image search',
'encyclopedia',
'explore user searches (hot keywords and trends)',
'Federal/Local Government',
'postal codes',
'boosting customer engagement/attraction metrics and visitor traffic (source, demographics, content viewed)',
'website creator for businesses',
'patent search',
'music I like recommendations (tell what you like)',
'movies/series I like recommendations (tell what you like)',
'games I like recommendations (tell what you like)',
'learning to code',
'free datasets',
'dictionary between two languages',
'search all files on the computer',
'Social bookmarking (Sharing your bookmarks)',
'A website for users to share their documents',
'Wikihow like website',
'A virtual wallet that accepts PayPal.',
'Email service',
'Programming Q/A',]


topics = ['Google Taxonomy',
'Conversion Topics',
'Craigslist Topics',
'Steam Game',
'Job Role',
...
sub_topics = {
'Google Taxonomy': ["Animals & Pet Supplies", 
...
'Conversion Topics': ['Current situation',
'Job / Work',
'Clothes',
'News',
...
"Total War EmpireWarhammer 40,000",
"X-Com UFO Defense",
"XCOM Enemy Unknown",
...
"Stacking",
"Stardw Valley",
"Tom Clancy's Sprinter Cell: Conviction",
"Baldur's Gate 2",
"Dark Souls 1",
"Dark Souls 2",
"Dark Souls 3",
...
'Gaming': ['Gaming'],
'Entertainment': ['Stars', 'Movies', 'TV', 'Music'],
'Learning': ['Space',
'technology',
'science',
'natural history',
